...
class LiteralString(Atom):
    ...
    # TODO: support UTF-16BOM, but in a way that makes it explicit that
    # this does not support usage in text streams.
    # TODO: how to prevent accidential UTF-16BOM?
    def write(self) -> Iterable[bytes]:
        return (b"(", escape_string(self.value), b")")
...
class Stream(Atom):
    ...
    def write(self) -> Iterable[bytes]:
        # TODO: iterative compression to limit memory use?
